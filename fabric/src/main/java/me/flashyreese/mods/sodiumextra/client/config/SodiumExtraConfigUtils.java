...
public class SodiumExtraConfigUtils {
    ...
    public static Component translatableName(ResourceLocation identifier, String category) {
    ...
    public static Component translatableTooltip(ResourceLocation identifier, String category) {
